...
void DashboardWindow::SetInstrumentList( wxArrayInt list )
{
    ...
    for( size_t i = 0; i < list.GetCount(); i++ ) {
        ...
        switch( id ){
            ...
            case ID_DBP_I_COG:
                instrument = new DashboardInstrument_Single( this, wxID_ANY,
                        getInstrumentCaption( id ), OCPN_DBP_STC_COG, _T("%05.1f") );
                break;
            case ID_DBP_M_COG:
                instrument = new DashboardInstrument_Single( this, wxID_ANY,
                        getInstrumentCaption( id ), OCPN_DBP_STC_MCOG, _T("%05.1f") );
                break;
            case ID_DBP_D_COG:
            ...
            case ID_DBP_I_HDT: //true heading
                ...
                instrument = new DashboardInstrument_Single( this, wxID_ANY,
                        getInstrumentCaption( id ), OCPN_DBP_STC_HDT, _T("%05.1f") );
                break;
            case ID_DBP_I_HDM:  //magnetic heading
                instrument = new DashboardInstrument_Single( this, wxID_ANY,
                        getInstrumentCaption( id ), OCPN_DBP_STC_HDM, _T("%05.1f") );
                break;
            case ID_DBP_D_AW:
            case ID_DBP_D_AWA:
